package com.york.exordi.widget;
...
public class HorizontalSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
   ...
   * spinner is set to appear. Setting it to true will cause indicator to be scaled up rather than
   * clipped.
  ...
  /**
   * Set a callback to override {@link HorizontalSwipeRefreshLayout #canChildScrollUp()} method.
  ...
  public interface OnChildScrollUpCallback {
    ...
    /**
     * Callback that will be called when {@link HorizontalSwipeRefreshLayout #canChildScrollUp()}
