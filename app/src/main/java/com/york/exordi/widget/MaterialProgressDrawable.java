...
public class MaterialProgressDrawable extends Drawable implements Animatable {
  ...
  MaterialProgressDrawable(Context context, View parent) {
    ...
    COLORS = new int[] {ContextCompat.getColor(context, R.color.colorPrimary)};
  ...
  private static class Ring {
    ...
    /**
     * Set the absolute color of the progress spinner. This is should only be used when animating
